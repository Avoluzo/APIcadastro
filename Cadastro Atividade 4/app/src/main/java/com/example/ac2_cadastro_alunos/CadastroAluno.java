...
import com.example.ac2_cadastro_alunos.api.CepApi;
...
public class CadastroAluno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cep.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() == 8) {
                    buscarCep(s.toString(), CadastroAluno.this);
                }
            }
        });
        ...
        if (id > 0) {
            alunoService.findById(id).enqueue(new Callback<Aluno>() {
                ...
                public void onFailure(Call<Aluno> call, Throwable t) {
                    Toast.makeText(CadastroAluno.this, "Registro não pode ser encontrado", Toast.LENGTH_LONG).show();
                }
            });
        }
    ...
    public void insertAluno(Aluno aluno) {
        ...
        call.enqueue(new Callback<Aluno>() {
            ...
            @Override
            public void onFailure(Call<Aluno> call, Throwable t) {
                Toast.makeText(CadastroAluno.this, "Cadastro não pode ser editado", Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<Aluno>() {
            ...
            public void onResponse(Call<Aluno> call, Response<Aluno> response) {
                if (response.isSuccessful()) {
                    // A solicitação foi bem-sucedida
                    Aluno createdPost = response.body();
                    Toast.makeText(CadastroAluno.this, "Editado com sucesso!", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
