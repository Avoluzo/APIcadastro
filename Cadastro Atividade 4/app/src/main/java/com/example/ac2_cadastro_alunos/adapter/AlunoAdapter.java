package com.example.ac2_cadastro_alunos.adapter;
...
import com.example.ac2_cadastro_alunos.CadastroAluno;

import com.example.ac2_cadastro_alunos.api.AlunoMockApi;
import com.example.ac2_cadastro_alunos.holder.AlunoHolder;
...
public class AlunoAdapter extends RecyclerView.Adapter<AlunoHolder> {
    ...
    public void deleteItem(int position) {
        ...
        AlunoService alunoService = AlunoMockApi.getAlunoService();
    ...
    public void editItem(int position) {
        int id = alunos.get(position).getId();
        Intent i = new Intent(context, CadastroAluno.class);
        i.putExtra("id",id);
